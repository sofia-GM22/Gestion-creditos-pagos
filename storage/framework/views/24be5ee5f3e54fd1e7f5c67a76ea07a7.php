        ...
        <div class="col-md-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('clientes.index')); ?>" class="btn btn-primary">Ir a Clientes</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('clientes.por-estado-credito')); ?>" class="btn btn-primary">Ver por estado</a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistema-gestion-creditos\resources\views/home.blade.php ENDPATH**/ ?>